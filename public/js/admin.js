...
function call(id) {
  ...
  socket.emit("admin_list_messages_by_user", params, (messages) => {
    var divMessages = document.getElementById(
    ...
    messages.forEach((message) => {
      ...
      if (message.admin_id === null) {
        ...
        createDiv.innerHTML = `<span><strong>${connection.user.email}</span>`;
...
socket.on("admin_receive_message", (data) => {
  ...
  var divMessages = document.getElementById(`allMessages${connection.user_id}`);
